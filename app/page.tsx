            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Link 
                    href="/servicios"
                    className="px-8 py-4 rounded-lg font-serif font-medium text-center transition-opacity hover:opacity-90 text-white"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
                <div className="mx-auto mb-6 flex items-center justify-center h-32">
                  <Image 
                    src="/icono-doc.gif" 
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow">
                <div className="mx-auto mb-6 flex items-center justify-center h-32">
                  <Image 
                    src="/icono-calculadora.gif" 
                    alt="Servicios de Liquidación" 
                    width={120}
                    height={120}
                    className="object-contain"
                    unoptimized
            ...
            <div className="text-center mt-12">
              <Link 
                href="/servicios"
                className="inline-block px-8 py-3 rounded-lg font-serif font-medium transition-opacity hover:opacity-90 text-white"
                style={{ backgroundColor: '#ff85ab' }}
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div className="border-l-4 pl-4" style={{ borderColor: '#ff85ab' }}>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-4">
              ...
              <details className="group bg-white rounded-xl p-6 shadow-sm border-l-4" style={{ borderColor: '#ff85ab' }}>
                <summary className="flex justify-between items-center cursor-pointer list-none">
                  <span className="font-serif font-semibold text-gray-900 text-lg">
                    ¿Qué tipo de empresas atienden?
                  </span>
                  <span className="transition group-open:rotate-180">
                    <svg className="w-5 h-5" fill="none" stroke="#ff85ab" strokeWidth="2" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
                    </svg>
                  </span>
                </summary>
